...
import am.victor.clean_like_app.databinding.FragmentSetupPersonalDataBinding
...
class SetupPersonalDataFragment :BindableFragment<SetupPersonalDataViewModel,FragmentSetupPersonalDataBinding>(), PictureDialog.PictureDialogListener {
    ...
    companion object {
        ...
        fun newInstance() = SetupPersonalDataFragment()
    }

    @Inject
    override lateinit var viewModel: SetupPersonalDataViewModel

    override val layoutID: Int
        get() = R.layout.fragment_setup_personal_data
    ...
    override fun setupBinding(binding: FragmentSetupPersonalDataBinding) {
