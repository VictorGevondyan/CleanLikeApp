package am.victor.clean_like_app.ui.setup_profile_customer.personal_data.viewmodel
...
class SetupPersonalDataViewModel(
    ...
    fun onSkipButtonClick() {
        navigation.show(SetupGeneralDataFragment.newInstance())
    }
