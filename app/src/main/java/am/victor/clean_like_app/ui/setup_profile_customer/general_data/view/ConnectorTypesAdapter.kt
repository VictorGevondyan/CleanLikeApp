...
class ConnectorTypesAdapter(private val setupGeneralDataViewModel: SetupGeneralDataViewModel) :
    RecyclerView.Adapter<ConnectorTypesAdapter.ConnectorTypeViewHolder>() {
    ...
    private fun setGlobalCheck(checkedCount: Int) {
        ...
        if (checkedCount > 0) {
            setupGeneralDataViewModel._isChecked.value = true
        } else if (checkedCount == 0) {
            setupGeneralDataViewModel._isChecked.value = false
        }
        ...
        fun bind(position: Int, evConnectorTypes: MutableList<EvConnectorTypes>) {
            ...
            binding.apply {
                ...
                itemDelete.setOnClickListener {
                    setupGeneralDataViewModel.deleteData(position)
                }
